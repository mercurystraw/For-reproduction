...
# 生成带有C0和C1标记的文件名
model_path = os.path.join(model_dir, f'train_clean_2_classes_model_{data}_C0_{config["C0"]}_C1_{config["C1"]}.pth')
