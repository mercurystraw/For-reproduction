...
model.load_state_dict(torch.load(f'./trained_models/contam_models/train_contam_2_classes_model_{config["PATTERN_TYPE"]}_{data}_C0_{config["C0"]}_C1_{config["C1"]}.pth'))
