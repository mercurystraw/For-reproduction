...
torch.save(train_attacks, f'./attacks/train_attacks_{data}_C0_{C0}_C1_{C1}')
torch.save(test_attacks, f'./attacks/test_attacks_{data}_C0_{C0}_C1_{C1}')
torch.save(ind_train, f'./attacks/ind_train_{data}_C0_{C0}_C1_{C1}')
...
plt.savefig(f'./attacks/image_clean_{data}_C0_{C0}_C1_{C1}.png')
...
plt.savefig(f'./attacks/image_poisoned_{data}_C0_{C0}_C1_{C1}_{PATTERN_TYPE}.png')
